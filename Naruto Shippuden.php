...
<table bordeer="0" align="left">
	<tr>
		<th><br><br><br><strong><big><big><p= style="color:white">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Naruto Shippuden</big></big></strong>
	<tr>	
		<!--Inicio dos detalhes do Anime-->
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\Naruto Shippuden.jpg" width="250" height="300"><br>
		<th><strong><p= style="color:white"><br>&emsp;&emsp;&emsp;Formato:</strong><p= style="color:white"> Anime<br>
		<strong><p= style="color:white">&emsp;&emsp;&emsp;Género:</strong><p= style="color:white">  Ação , Comédia , Shounen , Superpoder<br>
		...
		<strong><p= style="color:white">&emsp;&emsp;&emsp;Episódios:</strong> <p= style="color:white"> 112<br>	 
	...
	<tr>
		...
		<th><br><br><br><strong><p= style="color:white">Dois anos e meio se passaram após a partida de Uzumaki Naruto e Jiraiya da vila de Konoha, para um treinamento 	
		<br><strong><p= style="color:white">a parte com Naruto. Logo ao voltar à vila os primeiros a encontrá-lo foram Sakura e Konohamaru. Agora Naruto  
		<br><strong><p= style="color:white">e seus amigos não tem apenas que se preocupar com o resgate de Sasuke, mas também com uma organização 
		<br><strong><p= style="color:white">chamada Akatsuki, que está atrás dos Jinchuurikis (ninjas que carregam um Bijuu em seus corpos, junto a isso 
		<br><strong><p= style="color:white">inumeros outros acontecimentos ocorrem ao longo da série. 
		<br><strong><p= style="color:white">
		<br><strong><p= style="color:white">
		<br><strong><p= style="color:white"> 
		<br><strong><p= style="color:white"> 
		<!--Fim da Sinopse-->
	<tr>		
		...
		<br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="Naruto.html" class="btn btn-primary" role="button">Anterior</a>
		</th>
	...
	<tr>
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\Naruto Shippuden ep1.jpg" width="100" height="80"><br>
		<td><br><strong><a class="nav-link" href="#"><p= style="color:white">Voltando Para Casa<br>Episódio 1 
	<tr>
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\Naruto Shippuden ep2.jpg" width="100" height="80"><br>
		<td><br><strong><a class="nav-link" href="#"><p= style="color:white">Os Akatsuki Entram Em Ação<br>Episódio 2 
	<tr>
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\Naruto Shippuden ep3.jpg" width="100" height="80"><br>
		<td><br><strong><a class="nav-link" href="#"><p= style="color:white">Os Resultados Do Treinamento<br>Episódio 3 
