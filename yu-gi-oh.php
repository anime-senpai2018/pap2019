...
<table bordeer="0" align="left">
	...
	<tr>	
		...
		<strong><p= style="color:white">&emsp;&emsp;&emsp;Direção:</strong><p= style="color:white"> Kunihisa Sugishima<br>
		...
		<strong><p= style="color:white">&emsp;&emsp;&emsp;Episódios:</strong> <p= style="color:white"> 224<br>	 
	...
	<tr>
		...
		<th><br><br><br><strong><p= style="color:white">Yu-Gi-Oh! narra a história de Yugi, um estudante do colegial abaixo da média para quem foram dadas peças      
		<br><strong><p= style="color:white">fragmentadas de um antigo artefato egípcio, o Enigma do Milênio, por seu avô. Ao remontar o quebra-cabeça, ele é   
		<br><strong><p= style="color:white">possuído por uma outra personalidade que mais tarde é revelado ser o espírito de um faraó de 3.000, que perdeu     
		<br><strong><p= style="color:white">sua memória. Conforme a história avança, os dois (juntamente com os amigos de Yugi),tentam encontrar o  segredo
		<br><strong><p= style="color:white">das memórias perdidas do Faraó e seu nome com o jogo Duel Monsters virar um cenário prevalente no enredo.
		<!--Fim da Sinopse-->
	<tr>	
		...
		<br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="yu-gi-oh GX.html" class="btn btn-primary" role="button">Próximo</a>
		</th>
	...
	<tr>
		...
		<td><br><strong><a class="nav-link" href="yu-gi-oh ep1.php"><p= style="color:white"> O Coração Das Cartas<br>Episódio 1 
	<tr>
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\yu-gi-oh ep2.jpg" width="100" height="80"><br>
		<td><br><strong><a class="nav-link" href="yu-gi-oh ep2.php"><p= style="color:white"> O Grande Desafio<br>Episódio 2 
	<tr>
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\yu-gi-oh ep3.jpg" width="100" height="80"><br>
		<td><br><strong><a class="nav-link" href="yu-gi-oh ep3.php"><p= style="color:white">Viagem Ao Reino Dos Duelos<br>Episódio 3 
