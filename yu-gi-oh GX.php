...
<table bordeer="0" align="left">
	...
	<tr>	
		...
		<strong><p= style="color:white">&emsp;&emsp;&emsp;Direção:</strong><p= style="color:white"> Hatsuki Tsuji<br>
		...
		<strong><p= style="color:white">&emsp;&emsp;&emsp;Episódios:</strong> <p= style="color:white"> 180<br>	 
		...
		<strong><p= style="color:white">&emsp;&emsp;&emsp;Classificação:</strong><p= style="color:white"> 10 Anos
	...
	<tr>
		...
		<th><br><br><br><strong><p= style="color:white">Ambientado num futuro próximo, Yu-Gi-Oh! GX narra a história de Jaden Yuki a partir do momento em que
		<br><strong><p= style="color:white">começa a lutar numa academia de duelistas, a Duel Academy, pertencente a Kaiba Corp. A academia tem como
		<br><strong><p= style="color:white">objetivo de desenvolver ao máximo o potencial  de luta de seus alunos, que são divididos em três grupos:
		<br><strong><p= style="color:white">no Obelisco Azul está a elite,no Ra Amarelo estão aqueles com potencial e no Slifer Vermelho os jogadores de
		<br><strong><p= style="color:white">nível mais baixo. Enquanto está a caminho dos exames de admissão para a Academia de Duelos, Jaden Yuki bate de
	...
	<tr>
		...
		<td><br><strong><a class="nav-link" href="Yu-Gi-oh GX ep1.php"><p= style="color:white"> O Coração Das Cartas<br>Episódio 1 
	<tr>
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\yu-gi-oh GX ep2.jpg" width="100" height="80"><br>
		<td><br><strong><a class="nav-link" href="Yu-Gi-oh GX ep2.php"><p= style="color:white"> O Grande Desafio<br>Episódio 2 
	<tr>
		<th><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="img\yu-gi-oh GX ep3.jpg" width="100" height="80"><br>
		<td><br><strong><a class="nav-link" href="Yu-Gi-oh GX ep3.php"><p= style="color:white">Viagem Ao Reino Dos Duelos<br>Episódio 3 
